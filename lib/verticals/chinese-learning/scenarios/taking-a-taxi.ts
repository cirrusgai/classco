...
export const takingATaxi: ScenarioTemplate = {
  ...
  vocabularyDict: {
    '出租车': { pinyin: 'chūzūchē', meaning: 'taxi' },
    '司机': { pinyin: 'sījī', meaning: 'driver' },
    '师傅': { pinyin: 'shīfu', meaning: 'master/driver (respectful address)' },
    '去': { pinyin: 'qù', meaning: 'to go' },
    '到': { pinyin: 'dào', meaning: 'to arrive/to reach' },
    '路': { pinyin: 'lù', meaning: 'road/route' },
    '左转': { pinyin: 'zuǒ zhuǎn', meaning: 'turn left' },
    '右转': { pinyin: 'yòu zhuǎn', meaning: 'turn right' },
    '直走': { pinyin: 'zhí zǒu', meaning: 'go straight' },
    '红绿灯': { pinyin: 'hónglǜdēng', meaning: 'traffic light' },
    '路口': { pinyin: 'lùkǒu', meaning: 'intersection/junction' },
    '多远': { pinyin: 'duō yuǎn', meaning: 'how far?' },
    '多久': { pinyin: 'duō jiǔ', meaning: 'how long (time)?' },
    '堵车': { pinyin: 'dǔ chē', meaning: 'traffic jam' },
    '到了': { pinyin: 'dào le', meaning: 'arrived/we\'re here' },
    '停': { pinyin: 'tíng', meaning: 'to stop' },
    '付款': { pinyin: 'fùkuǎn', meaning: 'to pay' },
  },
  targetGrammar: [
